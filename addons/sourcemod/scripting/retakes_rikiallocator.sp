...
void EquipWeapons(int client)
{
	...
	if (g_iRoundType == FULL_ROUND)
	{
		...
		if (GetClientTeam(client) == CS_TEAM_CT)
		{
			int iRandom = GetRandomInt(1, 10);
			if (iRandom == 1 || iRandom == 2 || iRandom==3 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION) && g_bAWP[client] && gc_iAWP_MinCT.IntValue <= GetPlayerCount(true, CS_TEAM_CT))
			{
			...
			else if(iRandom == 4 && g_bAWP[client] && gc_iAWP_MinCT.IntValue <= GetPlayerCount(true, CS_TEAM_CT))
			{
				if (g_iAWP_CT < gc_iAWP_CT.IntValue)
				{
					GivePlayerItem(client, "weapon_awp");
		...
		{
			int iRandom = GetRandomInt(1, 10);
			if (iRandom == 1 || iRandom == 2 || iRandom == 3 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION) && g_bAWP[client] && gc_iAWP_MinT.IntValue <= GetPlayerCount(true, CS_TEAM_T))
			{
			...
			else if(iRandom == 4 && g_bAWP[client] && gc_iAWP_MinT.IntValue <= GetPlayerCount(true, CS_TEAM_T))
			{
				if (g_iAWP_T < gc_iAWP_T.IntValue)
				{
					GivePlayerItem(client, "weapon_awp");
	...
	else if (g_iRoundType == FORCE_ROUND)
	{
		...
		{
			int iRandom = GetRandomInt(1, 10);
			if (iRandom == 1 || iRandom == 2 || iRandom == 3 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION) && g_bScout[client] && gc_iScout_MinCT.IntValue <= GetPlayerCount(true, CS_TEAM_CT))
			{
			...
			else if(iRandom == 4 && g_bScout[client] && gc_iScout_MinCT.IntValue <= GetPlayerCount(true, CS_TEAM_CT))
			{
				if (g_iScout_CT < gc_iScout_CT.IntValue)
				{
					GivePlayerItem(client, "weapon_ssg08");
		...
		{
			int iRandom = GetRandomInt(1, 10);
			if (iRandom == 1 || iRandom==2 && (GetUserFlagBits(client) & ADMFLAG_RESERVATION) && g_bScout[client] && gc_iScout_MinT.IntValue <= GetPlayerCount(true, CS_TEAM_T))
			{
